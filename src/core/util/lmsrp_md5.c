...
/// this is copy from pjproject md5.c
 ...
 */
PJ_DEF(void) lmsrp_md5_init(lmsrp_md5_context *ctx)
{
 ...
 * of bytes.
 */
PJ_DEF(void) lmsrp_md5_update( lmsrp_md5_context *ctx,
 ...
 */
PJ_DEF(void) lmsrp_md5_final(lmsrp_md5_context *ctx, unsigned char digest[16])
{
    unsigned count;
    unsigned char *p;
